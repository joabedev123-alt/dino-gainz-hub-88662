...
export const AppProtocol = () => {
  return (
    <section id="sobre" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-secondary/30">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-up" style={{ animationDelay: "0.2s" }}>
            <h2 className="font-bebas text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tight">
              SOBRE ANDERSON SILVA
            </h2>
            <div className="space-y-4 sm:space-y-6 font-inter text-base sm:text-lg text-muted-foreground leading-relaxed">
              <p>
